            ...
            <div className='border-b border-base-300 w-full p-5'>
                ...
                <div className='mt-3 hidden lg:flex items-center gap-2'>
                    <label className='cursor-pointer flex items-center gap-2'>
                        <input type="checkbox" checked={showOnlineOnly} onChange={(e) => setOnlineShowOnly(e.target.checked)} className='checkbox checkbox-sm' />
                    ...
                    >
                        <div className='relative mx-auto lg:mx-0'>
                            ...
                            {onlineUsers.includes(users._id) && (
                                <span className='absolute bottom-0 right-0 size-3 bg-green-800 rounded-full ring-2 ring-[#444]' />
                            )}
                        </div>
